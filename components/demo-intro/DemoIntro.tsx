...
export function DemoIntro() {
  ...
  return (
    <section className="ki-story" aria-label="申し送り・面談・日報の使い方">
      <div className="ki-story-top">
        <span>使い方を見てみる</span>
        <span>約31秒 · 架空データでの紹介</span>
      </div>
      <div
      ...
      >
        <div
          ...
          inert
          style={{
            transform: `translate(${width / 2 - camera[0] * scale}px, ${168 - camera[1] * scale}px) scale(${scale})`,
          }}
        >
